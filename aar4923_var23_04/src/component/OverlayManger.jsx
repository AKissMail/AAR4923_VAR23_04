    ...
    return(
        <div>
            ...
            <Overlay isOpen={isOpen} onClose={toggleOverlay} >
                ...
                {selectedContent === 'content1' && <div><h1>{props.content.container[1].partyResponseHeadline}</h1><h4>{props.content.container[1].partyResponseDate}</h4><ol><li>{props.content.container[1].partyResponseText1}</li><li>{props.content.container[1].partyResponseText2}</li></ol></div>}
                ...
                {selectedContent === 'content3' && <div><h1>{props.content.container[3].partyResponseHeadline}</h1><h4>{props.content.container[3].partyResponseDate}</h4><ol><li>{props.content.container[3].partyResponseText1}</li><li>{props.content.container[3].partyResponseText2}</li></ol>{props.content.container[3].partyComment}</div>}
                ...
                {selectedContent === 'content8' && <div><h1>{props.content.container[8].partyResponseHeadline}</h1><h4>{props.content.container[8].partyResponseDate}</h4><ol><li>{props.content.container[8].partyResponseText1}</li><li>{props.content.container[8].partyResponseText2}</li></ol>{props.content.container[8].partyComment}</div>}
            </Overlay>
        </div>
    )
}
